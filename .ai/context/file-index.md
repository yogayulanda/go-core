...
- `security/` auth extraction and JWT helpers
- `errors/` shared error contract
- `templates/` implementation templates for downstream services
- `examples/` usage examples for consuming services
- `version/` version metadata helpers
- `docs/` framework guidance
